        ...
        case FinalReport(reportData) =>
            ...
            operationMode match {
                case Debug =>
                    ...
                    println(s"Speaking with Belief 0: $speakingBelief0")
                    println(s"Speaking with Belief 1: $speakingBelief1")
                    println(s"Silent with Belief 0: $silentBelief0")
                    println(s"Silent with Belief 1: $silentBelief1")
